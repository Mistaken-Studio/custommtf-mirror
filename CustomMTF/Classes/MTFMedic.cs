...
namespace Mistaken.CustomMTF.Classes
{
    public partial class MTFMedicHandler
    {
        ...
        public class MTFMedic : CustomClasses.CustomClass
        {
            ...
            /// <inheritdoc/>
            public override string Color => "lightblue";
            ...
            public override void Spawn(Player player)
            {
                ...
                player.SetGUI("cc_mtf_medic", API.GUI.PseudoGUIPosition.BOTTOM, $"You are <color=yellow>playing</color> as <color={this.Color}>MTF Medic</color>");
            }
